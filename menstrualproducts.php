<?php
    ...
    $sql = "SELECT menstrualproducts.brand AS brand, menstrualproducts.type AS type, menstrualproducts.price AS price, menstrualproducts.rating AS rating FROM menstrualproducts";
...
<body>
  ...
  <div id="mpinfo-page">
      Menstruation products are necessary for those who menstruate and should be accessible whenever and by whoever! Below you can find information on a few products that are provided in general stores.
  </div>
